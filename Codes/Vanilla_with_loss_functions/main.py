...
if __name__ == "__main__":
    ...
    for seed in seeds:
        ...
        dataset = Data_Loader(image_dir=path_to_images_dir, mask_dir=path_to_masks_dir, do_resize=do_resize_input_images)
        train_loader = torch.utils.data.DataLoader(dataset, batch_size=batch_size_is, shuffle=True, num_workers=8, pin_memory=True, prefetch_factor=4, persistent_workers=True, worker_init_fn=seed_worker, generator=g)
