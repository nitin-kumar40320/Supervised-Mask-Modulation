...
gt_folder = "/home/ayush/segmentation/Dataset015_Drive/labelsTs"
results_folder = "/home/ayush/segmentation/Results_5cv_unet/GMM_250/Drive/doubledilation" 
folds = [0,1,2,3,4]
image_extension = ".png"
...
if __name__=="__main__":
    ...
    for fold in folds:
        metric_output_folder = os.path.join(results_folder, f"fold_{fold}")
    ...
    all_folds_results = np.stack(results, axis=0)

    mean_metrics = np.mean(all_folds_results, axis=0)
    std_metrics = np.std(all_folds_results, axis=0)
