...
class Data_Loader(Dataset):
    def __init__(self, image_dir, mask_dir, alter_mask_dir, num_classes):
        ...
        self.general_transform = A.Compose([
            ...
            ToTensorV2()
            ], additional_targets={'alt_mask': 'mask'}, is_check_shapes=False)
    ...
    def __getitem__(self, idx):
        ...
        alt_mask_tensor = transformed['alt_mask'].long()
        ...
        return image_tensor, mask_tensor, alt_mask_one_hot, alter_mask_path
