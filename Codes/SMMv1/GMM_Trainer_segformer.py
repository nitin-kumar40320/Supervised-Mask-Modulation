...
class Segformer_Trainer:
    def __init__(self, model, dataloader, epochs, pretrain_epochs, num_classes, focus_classes, lr, device, loss, log_dir, pred_mask_dir, gt_mask_dir, transformed_mask_dir, save_checkpoint=500):
    ...
    def _mask_modulation(self):
        files = sorted(os.listdir(self.pred_mask_dir))

        for file in files:
            pred_mask_path = os.path.join(self.pred_mask_dir, file)
            gt_mask_path = os.path.join(self.gt_mask_dir, file)
            ...
            output_path = os.path.join(self.transformed_mask_dir, file)
    ...
    def train(self):
        ...
        for epoch in range(1, self.epochs + 1):
            ...
            for images, masks, transformed_masks, mask_name in self.dataloader:
