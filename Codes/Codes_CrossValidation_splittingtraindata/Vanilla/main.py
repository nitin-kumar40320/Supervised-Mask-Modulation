...
folds = [2,3,4]
dest_dir = "/home/ayush/segmentation/Results_5cv_unet/Vanilla_1000/Cracks"
...
def main(train_images_list, val_images_list, path_to_log_dir):
    ...
    trainer = Trainer(model, train_dataloader=train_loader, val_dataloader=val_loader, epochs=total_epochs, num_classes=num_classes, lr=learning_rate, device=device, loss=criterion, log_dir=path_to_log_dir, epoch_vis_img=epoch_visual_img)
