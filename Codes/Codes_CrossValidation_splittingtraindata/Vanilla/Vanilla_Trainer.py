...
class Trainer:
    def __init__(self, model, train_dataloader, val_dataloader, epochs, num_classes, lr, device, loss, log_dir, epoch_vis_img):
        ...
        with open(self.log_file, 'w') as f:
            f.write("Epoch, Loss, Val Dice Score, Train Dice Score, Dice Loss, CE Loss, Time\n")
    ...
    def train(self):
        for epoch in range(1, self.epochs + 1):
            ...
            for images, masks, mask_names in self.train_dataloader:
            ...
            epoch_dice_val = self.validate(epoch)
            
            with open(self.log_file, 'a') as f:
                f.write(f"{epoch}, {epoch_loss:.4f}, {epoch_dice_val:.4f}, {epoch_dice:.4f}, {epoch_dice_loss:.4f}, {epoch_ce_loss:.4f}, {epoch_time:.2f}\n")
