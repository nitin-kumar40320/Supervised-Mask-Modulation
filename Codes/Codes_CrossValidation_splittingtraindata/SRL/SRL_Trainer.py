...
class Trainer:
    def __init__(self, model, train_dataloader, val_dataloader, epochs, lr, device, loss, log_dir, number_of_classes, epoch_vis_img):
        ...
        with open(self.log_file, 'w') as f:
            f.write("Epoch, Loss, Val Dice Score, Train Dice Score, Dice Loss, CE Loss, SkelRec Loss Time\n")
    ...
    def validate(self):
        ...
        for images, masks, transformed_masks, mask_names in self.val_dataloader:
    ...
    def train(self):
        for epoch in range(1, self.epochs + 1):
            ...
            for images, masks, transformed_masks, mask_names in self.train_dataloader:
            ...
            epoch_skelrec_loss /= len(self.train_dataloader)
            epoch_dice /= len(self.train_dataloader)
            ...
            with open(self.log_file, 'a') as f:
                f.write(f"{epoch}, {epoch_loss:.4f}, {epoch_dice_val:.4f}, {epoch_dice:.4f}, {epoch_dice_loss:.4f}, {epoch_ce_loss:.4f}, {epoch_skelrec_loss:.4f}, {epoch_time:.2f}\n")
