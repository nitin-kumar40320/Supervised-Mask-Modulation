...
gt_folder = "/home/nitin1/segmentation/Dataset095_Drone/labelsTs"
results_folder = "/home/nitin1/segmentation/Results_unet/Focal_1000/Drone"
...
def evaluate_segmentation(gt_folder, pred_folder, metric_output_folder, image_extension, num_classes):
    ...
    headers = ["Class Name", "Dice scores", "clDice scores", "IoU scores", "False Negative Rate", "False Positive Rate"]
...
if __name__=="__main__":
    ...
    for i in range(len(names)):
        row = [names[i]] + [format_metric(mean_metrics[i, j], std_metrics[i, j]) for j in range(5)]
