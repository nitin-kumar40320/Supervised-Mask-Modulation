...
class Segformer_Trainer:
    def __init__(self, model, dataloader, epochs, num_classes, lr, device, loss, log_dir, save_checkpoint=500):
    ...
    def train(self):
        for epoch in range(1, self.epochs + 1):
            ...
            for images, masks, dist_map, mask_names in self.dataloader:
                images, masks, dist_map = images.to(self.device), masks.to(self.device), dist_map.to(self.device)
